  ...
  return (
    <>
      ...
      <div className="overflow-x-auto">
        <table className="border-separate border-spacing-0.5 border border-slate-500 table-fixe ">
          <tr className="bg-slate-200">
            <th className="border-separate border-spacing-0.5 border border-slate-500">
              Name
            </th>
            <th className="border-separate border-spacing-0.5 border border-slate-500">
              Address
          ...
          {NGODataForTable.map((val, index) => (
            <tr key={index} className="hover:bg-slate-200 hover:font-semibold	">
              ...
              <td className="w-[10%] border-separate border-spacing-0.5 border border-slate-500 text-sm ">
                {val[1][4]}
              </td>
              <td className="border-separate border-spacing-0.5 border border-slate-500 text-sm">
                {val[1][5]}
              ...
              <td className="border-separate border-spacing-0.5 border border-slate-500">
                <img src={val[1][7]} alt="NGO LOGO" className="h-24 w-24" />
              </td>
              <td className="border-separate border-spacing-0.5 border border-slate-500 text-sm">
                {val[1][8]}
              </td>
      ...
      <div className="flex flex-col justify-around md:flex-row sm:flex-col bg-amber-200 py-8">
        ...
        <div>
          <form
            className="px-3 py-3 sm:text-1"
            onSubmit={handleSubmitNGO}
            id="NGODataForm"
          >
            <h6 className="mt-1 text-sm leading-6 text-gray-600 ">
              NGO Details. This information will be displayed publicly so be
            ...
            <div className="flex gap-5 py-2">
              <div className="w-44">
                <label htmlFor="address" className="font-bold w-30">
                  NGO Address
                </label>
              </div>
              <input
            ...
            <div className="flex gap-5 py-2">
              <div className="w-44">
                <label htmlFor="regId" className="font-bold w-30">
                  NGO Reg ID
                </label>
              </div>
              <input
            ...
            <div className="flex gap-5 py-2">
              <div className="w-44">
                <label htmlFor="phoneNo" className="font-bold w-30">
                  NGO Phone No
                </label>
              </div>
              <input
            ...
            <div className="flex gap-5 py-2">
              <div className="w-44">
                <label htmlFor="type" className="font-bold w-30">
                  NGO Type
                </label>
              </div>
              <input
            ...
            <div className="flex gap-5 py-2">
              <div className="w-44">
                <label htmlFor="uniqueId" className="font-bold w-30">
                  NGO Unique ID
                </label>
              </div>
              <input
            ...
            <div className="flex gap-5 py-2">
              <div className="w-44">
                <label htmlFor="image" className="font-bold w-30">
                  NGO Image Link
                </label>
              </div>
              <input
            ...
            <div className="flex gap-5 py-2">
              <div className="w-44">
                <label htmlFor="sectors" className="font-bold w-30">
                  NGO Working Sectors
                </label>
              </div>
              <input
            ...
            <div className="flex gap-5 py-2">
              <div className="w-44">
                <label htmlFor="website" className="font-bold w-30">
                  NGO Website
                </label>
              </div>
              <input
        ...
        <div>
          <form className="px-3 py-3" onSubmit={handleSubmitNGODonationData}>
            <h6 className="mt-1 text-sm leading-6 text-gray-600 ">
              Donation Data. Please provide all the information about the
              donation.
            </h6>
            ...
            <div className="flex gap-5 py-2">
              <div className="w-44">
                <label htmlFor="ngoNameForDonation" className="font-bold w-30">
                  NGO Name
                </label>
              </div>
              <input
            ...
            <div className="flex gap-5 py-2">
              <div className="w-44">
                <label htmlFor="ngoFundUsage" className="font-bold w-30">
                  Fund Usage
                </label>
              </div>
              <input
            ...
            <div className="flex gap-5 py-2">
              <div className="w-44">
                <label htmlFor="ngoImageLink" className="font-bold w-30">
                  NGO Image Link
                </label>
              </div>
              <input
            ...
            <div className="flex gap-5 py-2">
              <div className="w-44">
                <label htmlFor="donationPageLink" className="font-bold w-30">
                  Donation Page Link
                </label>
              </div>
              <input
            ...
            <div className="flex gap-5 py-2">
              <div className="w-44">
                <label htmlFor="ngoSiteLink" className="font-bold w-30">
                  NGO Site Link
                </label>
              </div>
              <input
            ...
            <button
              type="reset"
              className="bg-green-500 text-white px-3 py-2 ml-6 rounded-md"
            >
              Reset
            </button>
          </form>
